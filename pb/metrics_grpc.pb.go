...
const (
	MonitorService_Monitor_FullMethodName = "/pb.MonitorService/Monitor"
)
...
type MonitorServiceClient interface {
	...
	Monitor(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Metrics, ServerMessage], error)
}
...
func (c *monitorServiceClient) Monitor(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Metrics, ServerMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MonitorService_ServiceDesc.Streams[0], MonitorService_Monitor_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Metrics, ServerMessage]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MonitorService_MonitorClient = grpc.BidiStreamingClient[Metrics, ServerMessage]
...
type MonitorServiceServer interface {
	// bidirectional stream: client sends Metrics; server can send ServerMessage anytime
	Monitor(grpc.BidiStreamingServer[Metrics, ServerMessage]) error
...
func (UnimplementedMonitorServiceServer) Monitor(grpc.BidiStreamingServer[Metrics, ServerMessage]) error {
...
func _MonitorService_Monitor_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MonitorServiceServer).Monitor(&grpc.GenericServerStream[Metrics, ServerMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MonitorService_MonitorServer = grpc.BidiStreamingServer[Metrics, ServerMessage]
